...
<head>
  ...
  <title>INTER BUY RENTA CAR | Automobili | Citroen C4 Grand Picasso </title>
      ...
      <div class="row">
        <div class="col-md-5 mb15">
            <div class="img-holder">
                <!-- <img src="/img/automobili/c4_1.jpg" alt="Smart forfour" class="img-fluid">
                 -->

                 
                <div class="owl-carousel">
                  <div class="item">
                    <a href="/img/automobili/picasso-naslovna.png" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/picasso-naslovna.png" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/picasso-1.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/picasso-1.jpg" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/picasso-2.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/picasso-2.jpg" alt="" />
                    </a>
                  </div>
                ...
                <div class="col-md-6 middle-center">
                    <h3>Karakteristike vozila</h3>
                      <div class="icon-holder">
                        ...
                        <span>Maksimalno do 7 putnika </span>
                      </div> <!-- icon-holder -->
