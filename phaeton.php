...
<head>
  ...
  <title>INTER BUY RENTA CAR | Automobili | Volkswagen Phaeton </title>
      ...
      <div class="row">
        <div class="col-md-5 mb15">
            <div class="img-holder">
                <!-- <img src="/img/automobili/phaeton _1.jpg" alt="Smart forfour" class="img-fluid"> -->

                <div class="owl-carousel">
                  <div class="item">
                    <a href="/img/automobili/phaeton-naslovna.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/phaeton-naslovna.jpg" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/phaeton-1.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/phaeton-1.jpg" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/phaeton-2.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/phaeton-2.jpg" alt="" />
                    </a>
                  </div>
            ...
            <div class="col-md-5">
                <div class="table-holder table-responsive">
                    <table class="table table-bordered">
                     ...
                     <tr>
                       <td>1</td>
                       <td class="cene-paketa">50 €</td>
                     </tr>
                     <tr>
                        <td>2-5</td>
                        <td class="cene-paketa">40 €</td>
                      </tr>
                     <tr>
                       <td>6-10</td>
                       <td class="cene-paketa">35 €</td>
                     </tr>
                     ...
                     <tr>
                       <td>30+</td>
                       <td class="cene-paketa">23 €</td>
                     </tr>
                     <tr>
                        <td>Depozit</td>
                        <td class="cene-paketa">400 €</td>
                      </tr>
