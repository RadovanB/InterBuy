...
<head>
  ...
  <title>INTER BUY RENTA CAR | Automobili | Smart </title>
...
<header class="header-main">
  ...
  <section class="car-details">
    <div class="container">
        <h2>Smart for four</h2>
      <div class="row">
        <div class="col-md-5 mb15">
            <div class="img-holder">
                <!-- <img src="img/automobili/smart-naslovna.jpg" alt="Smart forfour" class="img-fluid"> -->

                <div class="owl-carousel">
                  <div class="item">
                    <a href="/img/automobili/smart-naslovna.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/smart-naslovna.jpg" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/smart-2.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/smart-2.jpg" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/smart-1.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/smart-1.jpg" alt="" />
                    </a>
                  </div>
            ...
            <div class="col-md-5">
                <div class="table-holder table-responsive">
                    <table class="table table-bordered">
                     ...
                     <tr>
                       <td>20-30</td>
                       <td class="cene-paketa">15 €</td>
                     </tr>
                       
                     <tr>
                       <td>30+</td>
                       <td class="cene-paketa">14 €</td>
                     </tr>
                     <tr>
                        <td>Depozit</td>
                        <td class="cene-paketa">100 €</td>
                      </tr>
                ...
                <div class="col-md-6 middle-center">
                    <h3>Karakteristike vozila</h3>
                      <div class="icon-holder">
                        ...
                        <span>Maksimalno do 4 putnika </span>
                      </div> <!-- icon-holder -->
