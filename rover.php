...
<head>
  ...
  <title>INTER BUY RENTA CAR | Automobili | Range Rover Sport </title>
      ...
      <div class="row">
        <div class="col-md-5 mb15">
            <div class="img-holder">
                <!-- <img src="/img/automobili/rr_1.jpg" alt="Smart forfour" class="img-fluid"> -->

                <div class="owl-carousel">
                  <div class="item">
                    <a href="/img/automobili/rover-naslovna.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/rover-naslovna.jpg" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/rover-naslovna.png" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/rover-naslovna.png" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/rover-2.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/rover-2.jpg" alt="" />
                    </a>
                  </div>
            ...
            <div class="col-md-5">
                <div class="table-holder table-responsive">
                    <table class="table table-bordered">
                     ...
                     <tr>
                       <td>30+</td>
                       <td class="cene-paketa">28 €</td>
                     </tr>
                     <tr>
                        <td>Depozit</td>
                        <td class="cene-paketa">500 €</td>
                      </tr>
