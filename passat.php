...
<head>
  ...
  <title>INTER BUY RENTA CAR | Automobili | Volkswagen Passat 5.5 </title>
...
<body>
 ...
 <header class="header-main">
  ...
  <section class="car-details">
    <div class="container">
        <h2>Volkswagen Passat 5.5</h2>
      <div class="row">
        <div class="col-md-5 mb15">
            <div class="img-holder">
                <!-- <img src="/img/automobili/passat_1.jpg" alt="Smart forfour" class="img-fluid"> -->

                <div class="owl-carousel">
                  <div class="item">
                    <a href="/img/automobili/passat-naslovna.png" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/passat-naslovna.png" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/passat-1.png" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/passat-1.png" alt="" />
                    </a>
                  </div>
      
                  <div class="item">
                    <a href="/img/automobili/passat-2.jpg" data-gal="prettyPhoto">
                      <img class="img-fluid" src="/img/automobili/passat-2.jpg" alt="" />
                    </a>
                  </div>
